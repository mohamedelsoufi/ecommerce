...
<head>
  ...
  <link rel="shortcut icon" type="image/x-icon" href="{{url('public/theme/app-assets/images/ico/favicon.ico')}}">
      ...
      <ul class="nav navbar-nav flex-row">
        ...
        <li class="nav-item mr-auto">
          <a class="navbar-brand" href="{{url('admin')}}">
            <img class="brand-logo" alt="modern admin logo" src="{{url('public/theme/app-assets/images/logo/logo.png')}}">
        ...
        <ul class="nav navbar-nav mr-auto float-left">
            ...
            <ul class="mega-dropdown-menu dropdown-menu row">
              <li class="col-md-2">
                ...
                <div id="mega-menu-carousel-example">
                  <div>
                    <img class="rounded img-fluid mb-1" src="{{url('public/theme/app-assets/images/slider/slider-2.png')}}"
                ...
                <form class="form form-horizontal">
                  <div class="form-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <div class="position-relative has-icon-left">
                          <input class="form-control" type="text" id="inputName1" placeholder="John Doe" autocomplete="off">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <div class="position-relative has-icon-left">
                          <input class="form-control" type="email" id="inputEmail1" placeholder="john@example.com" autocomplete="off">
          ...
          <li class="nav-item nav-search"><a class="nav-link nav-link-search" href="#"><i class="ficon ft-search"></i></a>
            <div class="search-input">
              <input class="input" type="text" placeholder="Explore Modern..." autocomplete="off">
            </div>
          </li>
        </ul>

                      ...
                      <div class="row breadcrumbs-top">
                          <div class="breadcrumb-wrapper col-12">
                              <ol class="breadcrumb" style="margin-top: 25px;">
                                  ...
                                  <li class="breadcrumb-item active">Add Main categories
                                  </li>
                              </ol>
                          </div>
                      </div>
          ...
          <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard ">
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <form class="form" action="{{url('admin/main_categories/add')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-body">
                                        ...
                                        @foreach (app('langs') as $key => $lang)
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <br>
                                                    <input type="text" name="main_cate[{{$key}}][name]"value="{{ old('main_cate.' . $key . '.name') }}" class="form-control" autocomplete="off">

                              ...
                              <tbody>
                                  @foreach ($products as $product)
                                      <tr>
                                          ...
                                          <td>
                                              @if ($product->status == 1)
                                                <a href="{{url('/admin/products/active/' . $product->id)}}" class="btn btn-danger btn-min-width box-shadow-5 mr-1 mb-1" style="min-width: 6.5rem; margin-right: 8px !important;">{{$product->getChangStatus()}}</a>
                                              @else

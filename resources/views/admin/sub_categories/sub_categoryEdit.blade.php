                      ...
                      <div class="row breadcrumbs-top">
                          <div class="breadcrumb-wrapper col-12">
                              <ol class="breadcrumb" style="margin-top: 25px;">
                                  ...
                                  <li class="breadcrumb-item active">edit sub categories
                                  </li>
                              </ol>
                          </div>
                      </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="main_category_id">
                                                    @foreach ($main_categories as $main_category)
                                                        <option value="{{$main_category->id}}" @if ($main_category->id == $sub_category->Main_categories->id) selected @endif>{{$main_category->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
